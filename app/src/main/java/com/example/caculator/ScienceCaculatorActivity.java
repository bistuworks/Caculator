...
public class ScienceCaculatorActivity extends AppCompatActivity {
    ...
    private void addEventListener() {
        ...
        change.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ScienceCaculatorActivity.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWidgets();
        addEventListener();
        Toast.makeText(ScienceCaculatorActivity.this, "启动", Toast.LENGTH_SHORT).show();
    }
}
